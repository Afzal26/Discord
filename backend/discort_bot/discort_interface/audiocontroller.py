from backend.discort_bot.discort_interface.config import config
from backend.discort_bot.discort_interface.playlist import Playlist
from backend.discort_bot.discort_interface.audioelements.dummy import Dummy

class AudioController(object):
    def init(self,bot,guild,volume):
        self.bot = bot
